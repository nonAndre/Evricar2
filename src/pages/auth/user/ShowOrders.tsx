        ...
        {data.map((userOrders: UsersOrders, userIndex: number) => (
          <div key={userIndex} className="space-y-4">
            {userOrders.orders.map((order: Orders, orderIndex: number) => (
              <div
                key={orderIndex}
                className="flex flex-col md:flex-row rounded-lg overflow-hidden bg-white gap-4 shadow-xl"
              >
                ...
                <div className="flex flex-col w-full p-4 text-black space-y-2">
                  <div className="flex flex-row justify-between items-start sm:items-center gap-2">
                    ...
                    >
                      <p className="text-xl text-white font-bold">Remove</p>
                    </button>
                  </div>
                  ...
                  <p className="text-base sm:text-lg lg:text-xl">
                    <span className="font-semibold">Cerchi:</span>{" "}
                    {order.optional.circle}
                  </p>
                  <p className="text-base sm:text-lg lg:text-xl">
