...
function Login() {
  ...
  return (
    <div className="flex h-screen  bg-gradient-to-r from-green-200 to-green-300 justify-center items-center">
      <div className="flex flex-col w-3/6 h-9/12  rounded-2xl  items-center bg-white max-md:w-4/6 max-sm:w-5/6 shadow-2xl">
        <ToastContainer
          position="top-center"
          autoClose={1800}
          theme="colored"
        ...
        <div className="flex flex-col  w-full h-7/12 gap-9 px-5">
          <p className="flex px-4 pt-5 text-3xl text-green-400 font-tesla">
            Login
          </p>
          <input
            placeholder="Email"
